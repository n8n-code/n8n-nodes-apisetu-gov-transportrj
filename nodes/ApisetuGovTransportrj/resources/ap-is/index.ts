...
export const apIsDescription: INodeProperties[] = [
			...
			"options": [
				{
					"name": "Drvlc",
					"value": "Drvlc",
					"action": "Driving License",
					"description": "API to verify Driving License.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/drvlc/certificate"
						}
					}
				},
				{
					"name": "Rvcer",
					"value": "Rvcer",
					"action": "Registration of Vehicles",
					"description": "API to verify Registration of Vehicles.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/rvcer/certificate"
						}
					}
				}
			],
		...
		{
			"displayName": "POST /drvlc/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /rvcer/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
